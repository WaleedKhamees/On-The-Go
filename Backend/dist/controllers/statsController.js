...
exports.statsController = {
    getEasternStats: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var thisMonth, lastMonth, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    thisMonth = (_a.sent()).rows[0].sum;
                    return [4 /*yield*/, index_1.client.query("\n            select sum(i.item_price*c.quantity) \n            from contains as c,item as i,orderx as o\n            where i.category = 'Eastern' and c.item_id = i.item_id and o.order_id = c.order_id and\n            o.order_date < now() - interval '30 days' and o.order_date > now() - interval '60 days';\n            ")];
                case 2:
                    lastMonth = (_a.sent()).rows[0].sum;
                    res.status(200).json({ thisMonth: thisMonth, lastMonth: lastMonth });
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
    ...
    getWesternStats: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var thisMonth, lastMonth, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
    ...
    getDrinksStats: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var thisMonth, lastMonth, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
