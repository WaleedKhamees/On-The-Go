            ...
            <div className="flex py-8 px-16 justify-between" >
                ...
                <div className="space-y-8 ">
                    <div className="flex gap-[122px] ">
                        ...
                        <h2 className="h2 text-[#C4141C]"> {props.Price - props.Discount + props.Delivery + props.Price * 0.14} EGP</h2>
                    </div>
                    <button className="rounded-lg pr-2 pl-2 bg-RedPrimary w-full h-[50px]">
                        <p className="text-White text-center p-2  ">Processed to CHeckOut</p>
                    </button>
                </div>
            </div>
            <Footer />
